        ...
        <div class="card shadow-sm border-bottom-info">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('barang') ?>" class="btn btn-sm btn-danger btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                        ...
                        <div class="input-group">
                            <select name="jenis_id" id="jenis_id" class="custom-select" data-live-search="true">
                                ...
                                <?php foreach ($jenis as $j) : ?>
                                    <option <?= $barang['jenis_id'] == $j['id_jenis'] ? 'selected' : '';  ?> <?= set_select('jenis_id', $j['id_jenis']) ?> value="<?= $j['id_jenis'] ?>"><?= $j['kode_jenis'] . ' | ' . $j['nama_jenis'] ?></option>
                                <?php endforeach; ?>
                            </select>
                ...
                <input value="<?= set_value('kode', $barang['kode']); ?>" name="kode" id="kode" type="hidden" class="form-control" placeholder="Seri Barang...">
                <div class="row form-group">
    ...
    $(document).ready(function() {
        ...
        $("#jenis_id").change(function() {
            ...
            kodebarang.onload = function() {
                ...
                var tambahkode = parseInt(banyakkode[0].banyakbarang) + 1;
                console.log();
                if (kodejenis.length == 2) {
                    var kodeakhir = kodejenis.toString() + padLeadingZeros(tambahkode, 2).toString();
                }
                if (kodejenis.length == 1) {
                    var kodeakhir = kodejenis.toString() + padLeadingZeros(tambahkode, 3).toString();

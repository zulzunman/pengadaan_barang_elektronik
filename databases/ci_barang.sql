...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2022 at 04:39 PM
...
('B000001', '1201', 'Mouse', 15, 94, 'Mouse', '', '', '', '2g', 'Logitech', '', '12'),
('B000002', '1301', 'Keyboard', 0, 95, 'Keyboard', '', '', '', '2g', 'Logitech', '', '13');
...
('T-BK-22121100001', 1, 'B000001', 5, '2022-12-11');
...
('T-BM-22121100001', 2, 1, 'B000001', 20, '2022-12-11');
...
(1, 'Maman', '085348439785', 'Tanggerang'),
(2, 'Jujun', '081993335312', 'Madiun');
...
(1, 'Adminisitrator', 'admin', 'admin@admin.com', '025123456789', 'admin', '$2y$10$wMgi9s3FEDEPEU6dEmbp8eAAEBUXIXUy3np3ND2Oih.MOY.q/Kpoy', 1568689561, 'a388588c9db5cd5f0e0282180ab10ab5.png', 1),
(29, 'zunzul', 'zun', 'zunzul@mail.com', '0877766612', 'gudang', '$2y$10$RfUkjzRfZQQ74IWWraUob.c9VhBXuBH4/LjR4LRfNpg1W/FKG8xfK', 1670766711, 'user.png', 1);
...
--
ALTER TABLE `jenis`
  MODIFY `id_jenis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
